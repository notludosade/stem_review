...
assert(problems.length === 60, `Expected 60 Python problems, found ${problems.length}`);
...
topicCounts.forEach((count, topic) => assert(count === 10, `${topic}: expected 10 problems, found ${count}`));
